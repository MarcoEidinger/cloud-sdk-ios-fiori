...
for PLATFORM in "iOS" "iOS Simulator"; do
    ...
    UMBRELLA_RESOURCE_BUNDLE_PATH="$RELEASE_PATH/${UMBRELLA}_${NAME}.bundle" # Marco
    ...
    then
        ...
        echo  "Resources copied $RESOURCES_BUNDLE_PATH - $FRAMEWORK_PATH"
    fi

    # Marco: Copy resources bundle, if exists
    if [ -e $UMBRELLA_RESOURCE_BUNDLE_PATH ]
    then
        cp -r $UMBRELLA_RESOURCE_BUNDLE_PATH $FRAMEWORK_PATH
        echo  "UMB Resources copied $UMBRELLA_RESOURCE_BUNDLE_PATH - $FRAMEWORK_PATH"
    fi
