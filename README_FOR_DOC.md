...
This project currently contains two modules: **FioriCharts** and **FioriIntegrationCards**. This API documentation combines the two modules!

## More Details

See https://github.com/SAP/cloud-sdk-ios-fiori/README.md for more details
